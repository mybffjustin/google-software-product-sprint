...
import com.google.sps.entity.ServerStats;
...
public final class ServerStatsServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        ServerStats serverStats =
                new ServerStats(startTime, currentTime, maxMemory, usedMemory);
    ...
    /**
     * Converts a ServerStats instance into a JSON string using the Gson
     * library. Note: We first added the Gson library dependency to pom.xml.
     */
